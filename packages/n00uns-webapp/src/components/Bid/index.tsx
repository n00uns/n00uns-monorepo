import { Auction, AuctionHouseContractFunction } from '../../wrappers/n00unsAuction';
...
import { useAuctionMinBidIncPercentage } from '../../wrappers/n00unsAuction';
...
const Bid: React.FC<{
  ...
  const fomoN00unsBtnOnClickHandler = () => {
    ...
    window.open('https://fomon00uns.wtf', '_blank')?.focus();
  };
